  ...
  render() {
    ...
    const sqA = (
      <rect
        ...
        width={fontSize * 0.7}
        height={fontSize * 0.7}
        transform={`rotate(${(triangle.ab.angle * 180) / PI - 90} ${ax} ${ay})`}
      />
    );
    const sqB = (
      <rect
        ...
        width={fontSize * 0.7}
        height={fontSize * 0.7}
        transform={`rotate(${(triangle.bc.angle * 180) / PI + 90} ${bx} ${by})`}
      />
    );
    const sqC = (
      <rect
        ...
        width={fontSize * 0.7}
        height={fontSize * 0.7}
        transform={`rotate(${(-triangle.cb.angle * 180) / PI} ${cx} ${cy})`}
      />
    );
    return (
      <div className={styles.container}>
        ...
        >
          ...
          />
          <circle
            className={classnames('TriangleDrawing__orthocenter', {
              hidden: !showOC,
            })}
            cx={ox}
            cy={oy}
